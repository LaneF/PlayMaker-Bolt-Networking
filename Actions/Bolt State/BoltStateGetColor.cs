...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get a Color Property from a Bolt Entity.")]
	public class BoltStateGetColor : FsmStateAction
	{
		[RequiredField]
        ...
        public void Main()
        {
            ...
            storeResult.Value = (Color)Get.Property(_go, propertyName.Value);
        }
	}
}

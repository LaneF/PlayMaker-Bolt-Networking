...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get an Integer Property from a Bolt Entity.")]
	public class BoltStateGetInt : FsmStateAction
	{
		[RequiredField]
        ...
        public void Main()
        {
            ...
            storeResult.Value = (int)Get.Property(_go, propertyName.Value);
        }
	}
}

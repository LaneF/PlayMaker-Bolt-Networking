...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get a String Property from a Bolt Entity.")]
	public class BoltStateGetString : FsmStateAction
	{
		[RequiredField]
        ...
        public void Main()
        {
            ...
            storeResult.Value = (string)Get.Property(_go, propertyName.Value);
        }
	}
}

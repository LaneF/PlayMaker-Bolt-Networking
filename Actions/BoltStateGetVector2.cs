...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Get a Vector2 Property from a Bolt Entity.")]
	public class BoltStateGetVector2 : FsmStateAction
	{
		[RequiredField]
        ...
        public void Main()
        {
            ...
            storeResult.Value = (Vector2)Get.Property(_go, propertyName.Value);
        }
	}
}
